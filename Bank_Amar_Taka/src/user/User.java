...
public class User implements Serializable{
	...
	public User(String username, String firstName, String lastName, String email, String phone, String address, String dateOfBirth,String gender, String password)
	{
	...
	// This method saves the User object to its 'username.txt' file;

	public void saveFile()
	{	try{
			ObjectOutputStream file = new ObjectOutputStream(new FileOutputStream("users/"+this.getUsername()+".txt"));
	...
	public void deleteAccount()
	{
		...
		try{
				File userFile = new File("users/"+this.getUsername()+".txt");
